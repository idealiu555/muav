...
# python plot_comparison.py --files train_logs/amasac.json train_logs/masac.json train_logs/maddpg.json train_logs/mappo.json train_logs/random.json --labels "AMASAC" "MASAC" "MADDPG" "MAPPO" "Random" --output comparison_reward.png --metric reward
